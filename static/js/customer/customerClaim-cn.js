...
var Detail = {template: '<div>' +
        ...
        '                                                <option selected value="cloth">衣物</option>' +
        ...
        '' +
        '                                    <div class="form-group row">' +
        '                                        <label class="col-form-label col-xs-8 col-md-3" for="itemName">物品名称:</label>' +
        '                                        <div class="col-md-8">' +
        ...
        '                                    </div>' +
        '                                    <div class="form-group row">' +
        '                                        <label class="col-form-label col-xs-8 col-md-3" for="itemEmail">联系邮件:</label>' +
        '                                        <div class="col-md-8">' +
        ...
        '                            </form>' +
        '                        </div>' +
        '<button type="button" id="submit" class="btn btn-lg btn-primary step-button">提交</button>' +
        ...
        '                                        <div class="row">\n' +
        '                                            <!--<div class="dateStart">-->\n' +
        '                                            <div class="infMargin insurnInf col-xs-12 col-md-6" style="color: #0d5bdd;">索赔单号: </div>\n' +
        '                                            <div class="orderNum infMargin col-md-6">{{claimOrderNum}}</div>\n' +
        '                                            <!--</div>-->\n' +
        '                                        </div>\n' +
        '                                        <div class="row">\n' +
        '                                            <!--<div class="dateEnd">-->\n' +
        '                                            <div class="infMargin insurnInf col-xs-12 col-md-6" style="color: #0d5bdd;">预测赔偿金: </div>\n' +
        ...
        '                                        <div class="card-body">\n' +
        '                                            <div class="row">\n' +
        '                                                <div class="infMargin insurnInf col-xs-12 col-md-6" style="color: #0d5bdd;">物品种类: </div>\n' +
        '                                                <div class="orderNum infMargin col-md-6">{{claimSubmit.itemType}}</div>\n' +
        '                                            </div>\n' +
        '                                            <div class="row">\n' +
        '                                                <div class="infMargin insurnInf col-xs-12 col-md-6" style="color: #0d5bdd;">物品价格: </div>\n' +
        '                                                <div class="orderMon infMargin col-md-6">{{claimSubmit.itemPrice}}</div>\n' +
        '                                            </div>\n' +
        '                                            <div class="row">\n' +
        '                                                <div class="infMargin insurnInf col-xs-12 col-md-6" style="color: #0d5bdd;">赔偿比率: </div>\n' +
        ...
        '                        <a type="button" class="btn btn-success" data-dismiss="modal">确认 <i class="far fa-gem ml-1 text-white"></i></a>' +
        '                    </div>' +
        '                </div>' +
        '                <!--/.Content-->' +
        '            </div>' +
